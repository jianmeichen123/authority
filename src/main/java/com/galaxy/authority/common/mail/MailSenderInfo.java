...
public class MailSenderInfo {
	...
	public MailSenderInfo() {
		...
		mailServerHost = property.getProperty(StaticConst.MAIL_HOST_KEY);
		mailServerPort = property.getProperty(StaticConst.MAIL_SMTP_PORT_KEY);
		fromAddress = property.getProperty(StaticConst.MAIL_ADDRESS_KEY);
		userName = property.getProperty(StaticConst.MAIL_USERNAME_KEY);
		//password = property.getProperty(Constants.MAIL_PASSWORD_KEY);
		password = "oN1oAyt4";
		validate = property.getProperty(StaticConst.MAIL_SMTP_AUTH_KEY).equals("true");
